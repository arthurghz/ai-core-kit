...
//
// Options:
//   --archetype <backend-api|fullstack|monorepo|library-sdk|infra-iac>
...
${c.bold("Options:")}
  --archetype <name>   backend-api | fullstack | monorepo | library-sdk | infra-iac
...
function writeManifest(manifestPath, manifest) {
  const banner =
    ...
    "# Schema: templates/manifest/project.manifest.schema.json (schema_version 2).\n";
