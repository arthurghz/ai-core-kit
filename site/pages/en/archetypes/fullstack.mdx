...
| `language` | `project.language` | not asked — derived: always `typescript` |
| `runtime`, `package_manager` | `project.runtime`, `project.package_manager` | `runtime` universal; `package_manager` derived: `pnpm` |
