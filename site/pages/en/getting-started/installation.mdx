...
| You want… | You need |
|---|---|
| The **`npx create-ack`** CLI (primary path) | **Node.js ≥ 18** and a terminal. `npx` ships with npm. |
...
### A. `npx create-ack` — fork-free CLI (recommended)
...
> **Which should I use?** Prefer **`npx create-ack`** — it is fork-free, faster, and the
