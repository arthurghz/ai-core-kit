...
- [`docs/REFERENCES.md`](https://github.com/arthurghz/ai-core-kit/blob/main/docs/REFERENCES.md) — the **license ledger**: every external repository the kit studied or borrows from, with its SPDX identifier and what we take.
- [`THIRD_PARTY_NOTICES.md`](https://github.com/arthurghz/ai-core-kit/blob/main/THIRD_PARTY_NOTICES.md) — **attribution** for material the kit actually vendors (copies files from).
