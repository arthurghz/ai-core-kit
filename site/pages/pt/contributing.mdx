...
Todo primitivo do Claude Code é markdown com frontmatter YAML. As regras abaixo são o padrão canônico ([CONVENTIONS.md](https://github.com/stallae/ai-core-kit/blob/main/docs/CONVENTIONS.md)) e são **impostas mecanicamente** (veja §3).
