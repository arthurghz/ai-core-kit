...
|---|---|
| A CLI **`npx create-ack`** (caminho principal) | **Node.js ≥ 18** e um terminal. O `npx` vem com o npm. |
...
### A. `npx create-ack` — CLI sem fork (recomendado)
...
npx create-ack my-product --archetype fullstack
```
...
> **Qual devo usar?** Prefira **`npx create-ack`** — é sem fork, mais rápido e o caminho
