...
## Surface
<!-- TODO(P4): DEEP contract body (interface, invariants, acceptance, owners,
     review/approval workflow tied to contract_gate.require_approval_by) is
     deferred to P4. This skeleton gives the gate a real contract-file shape to
     point at and the renderer a real template to scaffold from. -->
