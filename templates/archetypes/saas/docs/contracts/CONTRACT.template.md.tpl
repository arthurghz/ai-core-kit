...
## Surface
<!-- TODO(P4): DEEP contract body (route/page/billing/data interface, invariants,
     acceptance, owners, approval workflow tied to contract_gate.require_approval_by)
     is deferred to P4. This skeleton gives the gate a real contract-file shape.
     For a SaaS slice a contract typically covers one of: an app/ route group, a
     billing route, or a db/ schema change. -->
