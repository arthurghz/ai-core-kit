#!/usr/bin/env python3
# =============================================================================
# dora.py -- ai-core-kit DORA "four keys" metrics from local git  (CHILD layer)
# =============================================================================
# Shipped into a forked project by `/ack-init` when telemetry.enabled: true.
# This is the SAME engine as the kit's META telemetry/dora.py -- it reads only
# the local git history (and optional `gh`), so it has no manifest/CLI defaults
# to localize; it runs identically in a child repo. See README for wiring it
# into the observability exporter alongside the cost metrics.
#
# WHAT THIS IS
